...
var Worker = /** @class */ (function () {
    ...
    /**
     * Gets the list of plain text body of specified messages.
     *
     * @param  uids  specified uid of message.
     * @return               The list of plain text body of specified messages.
     */
    Worker.prototype.getMessagewithUids = function (uids) {
        return __awaiter(this, void 0, void 0, function () {
            var client, messages, finalMessages;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        console.log("IMAP.Worker.getMessagewithUids()", uids.length);
                        return [4 /*yield*/, this.connectToServer()];
                    case 1:
                        client = _a.sent();
                        return [4 /*yield*/, client.listMessages("INBOX", uids, ["body[]"], { byUid: true })];
                    case 2:
                        messages = _a.sent();
                        return [4 /*yield*/, client.close()];
                    case 3:
                        ...
                        finalMessages = [];
                        messages.forEach(function (inValue) {
                            finalMessages.push(inValue["body[]"]);
                        });
                        return [2 /*return*/, finalMessages];
                }
            });
        });
    }; /* End getMessagewithUids(). */
    /**
   ...
   */
    ...
    /**
     * Gets the namespaces list
     * @return               The namespaces list.
     */
    Worker.prototype.listNamespaces = function () {
        return __awaiter(this, void 0, void 0, function () {
            var client, namespaceObjects;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        console.log("IMAP.Worker.listNamespaces()");
                        return [4 /*yield*/, this.connectToServer()];
                    case 1:
                        client = _a.sent();
                        return [4 /*yield*/, client.listNamespaces()];
                    case 2:
                        namespaceObjects = _a.sent();
                        return [4 /*yield*/, client.close()];
                    case 3:
                        _a.sent();
                        return [2 /*return*/, namespaceObjects];
                }
            });
        });
    }; /* End listNamespaces(). */
    /**
     * Gets list of unseen messages
     *
     * @return               The unseen messages list.
     */
    Worker.prototype.searchUnseenMessage = function () {
        return __awaiter(this, void 0, void 0, function () {
            var client, namespaceObjects;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        console.log("IMAP.Worker.searchUnseenMessage()");
                        return [4 /*yield*/, this.connectToServer()];
                    case 1:
                        client = _a.sent();
                        return [4 /*yield*/, client.search('INBOX', { unseen: true })];
                    case 2:
                        namespaceObjects = _a.sent();
                        return [4 /*yield*/, client.close()];
                    case 3:
